...
?>
<div id='reload_card_templates_dialog' class='awkb_dialog'>
	...
	<br>
	<p>
		<a id="reload_card_templates" href="#" onclick="reload_card_templates();" class='action with-text' title='<?php echo translate("Reload card templates"); ?>'><img src='models/site-templates/images/reload_from_disk.png'><?php echo translate('Reload'); ?></a>
	...
	<script type="text/javascript">
		function reload_card_templates() {
			$.ajax({
				type: "POST", 
				url: "reload_card_templates_action.php", 
				data: {
					verbose: 1
				},
