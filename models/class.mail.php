<?php
class userMail {
	//We use a text based system with hooks to replace various strs in txt email templates
	...
	public function sendMail($email, $subject, $msg = NULL) {
		global $website_name, $email_address;

		$header = "MIME-Version: 1.0\r\n";
		$header .= "Content-type: text/plain; charset=iso-8859-1\r\n";
		$header .= "From: " . $website_name . " <" . $email_address . ">\r\n";
